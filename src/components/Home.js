          ...
          <section className="row m-1 p-1">
            <div className="col-md-6 rounded position-center border m-3 p-3" style={style.div}>
              ...
              <div className="row ">
                <div className="col-md-12">
                  <p>
                    My name is Joshua Jainga! I have my Bachelor's in Economics and I am currently an operations manager and have been trying to find what I want to do with my career. Through my experience at work I have found skills that I know that will take me closer to my goal. I am currently learning skills that align more with what my passions and interests are in the hopes that I will be able to take the next step in my career.
                  </p>
