          ...
          <section className="row m-1 p-1">
            <div className="col-md-6 rounded position-center border m-3 p-3" style={style.div}>
              ...
              <div className="row ">
                <div className="col-md-12">
                  <p>
                    My name is Joshua Jainga! I have my Bachelor's in Economics, I am currently an operations manager and have been trying to find what I want to do with my career.
                  </p>
